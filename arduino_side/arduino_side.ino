...
void servoCommand(int command, int angle){
    if(command == 5)
     {
    ...
    {
      myservo.write(11, angle);
    }//sudut 148
    else if(command == 7)
    {
      myservo.write(14, angle);
    }//sudut 102
    //if(command == 2){defarmpos();}//sudut 102 //default arm position  
